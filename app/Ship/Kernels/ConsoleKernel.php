...
use App\Containers\AppSection\Exam\Jobs\ExamEndTrackerJob;
use App\Containers\AppSection\Exam\Jobs\ExamStartTrackerJob;
use App\Containers\AppSection\Otp\Jobs\DeleteGarbageOtpsJob;
...
class ConsoleKernel extends LaravelConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->job(new DeleteGarbageOtpsJob)->dailyAt('01:00');
    }
